...
namespace DaXuaBa
{
    public partial class frmQuanLySanBay : Form
    {
        ...
        {
            DataTable dtSanBay = airportbus.GetDataAirport();
        ...
        {
            if (txtMaSanBay.Text != "" && txtTenSanBay.Text != "" && txtTenThanhPho.Text != "")
            {
                try
                {
                ...
                {
                    dtgvSanBay.DataSource = airportbus.GetDataAirport();
                }
            }
            else
            {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            if (txtMaSanBay.Text != "")
            {
                if (txtTenSanBay.Text != "" && txtTenThanhPho.Text != "")
                {
                    try
                    {
                        AirportDTO dto = new AirportDTO(txtMaSanBay.Text, txtTenSanBay.Text, txtTenThanhPho.Text);
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (txtMaSanBay.Text.Trim() != "")
            {
                ...
                {
                    AirportDTO dto = new AirportDTO(txtMaSanBay.Text, txtTenSanBay.Text, txtTenThanhPho.Text);
                    if (airportbus.DeleteAirport(dto))
